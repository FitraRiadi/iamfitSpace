// OrbitImages — React Bits component (by Dominik Koch, https://x.com/dominikkoch)
// Adapted for IamFit Space: import switched from 'motion/react' to 'framer-motion'
// (same engine, avoids a new dependency).
